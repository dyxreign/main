...
function LuannyUi:CreateWindow(config) 
    ...
    WindowConfig = { 
        ...
        IntroIcon = config.IntroIcon or "rbxassetid://8834748103",
        IntroText = config.IntroText or config.Title or "Luanny UI"
    } 
    ...
    if WindowConfig.Position == "Top" then
        ...
        btnTogglePos = UDim2.new(0.5, 0, 1, 5)
    ...
    elseif WindowConfig.Position == "Left" then
        ...
        btnTogglePos = UDim2.new(1, 5, 0.5, 0)
    ...
    elseif WindowConfig.Position == "Right" then
        ...
        btnTogglePos = UDim2.new(0, -5, 0.5, 0)
        ...
        btnTogglePos = UDim2.new(0.5, 0, 0, -5)
    ...
    toolbarStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    ...
    BtnToggleBar.Size = UDim2.new(0, 32, 0, 32)
    BtnToggleBar.AnchorPoint = btnToggleAnchor 
    BtnToggleBar.Position = btnTogglePos 
    BtnToggleBar.BackgroundColor3 = bgColor
    BtnToggleBar.BackgroundTransparency = bgAlpha
    BtnToggleBar.ImageColor3 = theme.Text 
    BtnToggleBar.ZIndex = 6 
    Instance.new("UICorner", BtnToggleBar).CornerRadius = UDim.new(1, 0)
    local toggleStroke = Instance.new("UIStroke", BtnToggleBar)
    ...
    if useIntro then
        task.spawn(function()
            ...
            local title = Instance.new("TextLabel", introContainer)
            title.Text = WindowConfig.IntroText
            title.Size = UDim2.new(1, 0, 0, 48)
            title.AnchorPoint = Vector2.new(0.5, 0.5)
            title.Position = UDim2.new(0.5, 25, 0.5, 0)
            ...
            TweenService:Create(logo, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, -(textBounds/2) - 15, 0.5, 0)}):Play()
            task.wait(0.3)
...
function LuannyUi:Tab(options) 
    ...
    tabWindowStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
...
function TabClass:ColorPicker(options)
    ...
    hueMarkerStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
